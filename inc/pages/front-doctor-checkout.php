...
<div class="doctor-checkout">
    ...
    ?>
        <div class="patient-info">
            ...
            <div class="patient-all-data">
                ...
                <div class="input-group-patient">
                    <label for="patient-postcode">کد پستی</label>
                    <input type="text" id="patient-postcode" placeholder="کد پستی" required>
                </div>
            </div>
    ...
    <div class="checkout-product-list">
        ...
        ?>
            ...
            <div class="input-group-patient">
                <label for="patient-phone">تصویر فیش پرداختی</label>
                <input type="file" accept="image/*" id="patient-receipt-image" required>
            </div>
            <p class="patient-form-upload-error" id="patient-form-upload-error">لطفا فیش پرداختی را انتخاب کنید</p>

            <button class="checkout-pay-button" onclick="processPayment()">بارگذاری فیش پرداختی</button>
        <?php
        }
        ?>
    </div>
