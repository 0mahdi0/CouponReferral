                    ...
                    if ($result != false) {
                        if ($result->ResCode == 0) {
                            ...
                            if (isset($applied_coupons[0]) && !in_array('doctor', $user_roles)) {
                                ...
                                $wallet_amount = UserCashbackBalance($parent_user_id, $total_amount);
                            ...
                            if (in_array('doctor', $user_roles)) {
                                ...
                                $wallet_amount = UserCashbackBalance($customer_id, $total_amount * ($doctorDiscount / 100));
                                $sms->WalletSms($phone, $user->display_name, $wallet_amount, "", $total_amount, $order_id, "doctor");
                            }
